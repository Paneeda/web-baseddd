import LoansImg from "/lg/loans-1.png"
                    ...
                    <section>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 ">
                            ...
                            <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow-xs">
                                <a href="#">
                                    <img className="rounded-t-lg p-1 " src={Logo} alt="" />
                                </a>
                            ...
                            <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow-xs">                                             <a href="#">
                                <img className="rounded-t-lg p-1 " src={Logo} alt="" />
                            </a>
