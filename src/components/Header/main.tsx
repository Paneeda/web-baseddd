            ...
            <div className="hidden lg:block lg:ml-4">
              <div className="flex items-center">
                <div className="relative">
                  <a href="/" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('Home')}</a>
                </div>

                <div className="relative">
                  <a href="/aboutus" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('Aboutus')}</a>
                </div>

                <div className="relative">
                  <a href="/news" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('News')}</a>
                </div>

                <div className="relative group">
                  <a href="#" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('Product&Service')}</a>
                  <div className="absolute left-0 mt-2 w-56 bg-white shadow-lg py-2 z-50 hidden group-hover:block border border-gray-100 rounded-md">
                    <a href="/loan" className="block px-4 py-2 text-sm text-gray-700 hover:bg-bic-navy hover:text-white">{t('Loan')}</a>
                ...
                <div className="relative">
                  <a href="/forms" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('Forms')}</a>
                </div>

                <div className="relative">
                  <a href="/career" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('Career')}</a>
                </div>

                <div className="relative">
                  <a href="/contactus" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800 hover:bg-bic-navy hover:text-white focus:outline-none focus:text-white focus:bg-bic-navy-dark transition">{t('ContactUs')}</a>
                </div>
