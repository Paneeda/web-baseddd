...
const Header: React.FC = () => {
  ...
  return (
    <div className="relative z-10 p-2 border-black bg-white-300 shadow">
      <div className="w-auto mx-auto  sm:px-4 lg:px-8">
            ...
            <div className="hidden ps-8  lg:block lg:ml-2">
              <div className="flex items-center">
                <div className="relative">
                  <a href="/" className="ml-4  px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800  hover:bg-bic-navy hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white
                   focus:bg-bic-navy-dark">{t('Home')} </a>
                </div>

                <div className="relative">
                  <a href="/aboutus" className="rounded-md text-sm leading-5 font-medium text-gray-800 hover:bg-bic-navy hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none 
                ...
                <div className="relative">
                  ...
                  {activeDropdown === 'product' && (
                    <div className="absolute left-0 mt-2 py-2 w-48 bg-white rounded-md shadow-lg z-10">
                      <a href="/deposit" className="block px-4 py-2 text-sm text-gray-700 hover:bg-bic-navy hover:text-white">Deposit</a>
                      <a href="/loan" className="block px-4 py-2 text-sm text-gray-700 hover:bg-bic-navy hover:text-white">Loans</a>
                      <a href="/atm" className="block px-4 py-2 text-sm text-gray-700 hover:bg-bic-navy hover:text-white">ATM</a>
                      <a href="/feencharge" className="block px-4 py-2 text-sm text-gray-700 hover:bg-bic-navy hover:text-white">Fee and Charges</a>
                    </div>
                  )}
                </div>
                ...
                <div className="relative">
                  <a href="/contactus" className="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 hover:bg-bic-navy hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none 
                  focus:text-white focus:bg-bic-navy-dark">{t('ContactUs')} </a>
                </div>
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                {languages.map((language) => (
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out ${currentLanguage === language.code ? 'bg-blue-50 text-blue-700' : ''
                      }`}
                  >
